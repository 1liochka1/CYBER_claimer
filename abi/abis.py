...
with open(get_path('claim_abi.json')) as f:
    claim_abi = json.load(f)

token_abi = '[{"inputs":[],"name":"name","outputs":[{"internalType":"string","name":"","type":"string"}],' \
            ...
            '"stateMutability":"view","type":"function"},{"anonymous":false,"inputs":[{"indexed":true,' \
